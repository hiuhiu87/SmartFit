...
class UserProfileModel(SQLModel, table=True):
    ...
    injuries: list[str] = Field(default_factory=list, sa_column=Column(ARRAY(String()), nullable=False))
...
class UserEquipmentModel(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("user_id", "equipment_type", name="uq_user_equipment_user_equipment_type"),)
...
class UserPreferenceModel(SQLModel, table=True):
    ...
    preferred_workout_days: list[str] = Field(default_factory=list, sa_column=Column(ARRAY(String()), nullable=False))
    preferred_session_minutes: int = Field(default=45)
    dislikes: list[str] = Field(default_factory=list, sa_column=Column(ARRAY(String()), nullable=False))
