...
from src.presentation.api.v1.program_router import router as program_router
from src.presentation.api.v1.readiness_router import router as readiness_router
from src.presentation.api.v1.training_router import router as training_router
...
v1_router.include_router(program_router)
